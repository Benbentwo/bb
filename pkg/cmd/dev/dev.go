...
import (
	"github.com/Benbentwo/bb/pkg/cmd/utils"
...
func NewCmdDev(commonOpts *opts.CommonOptions) *cobra.Command {
...
func AskForString(response *string, message string, defaultValue string, req bool, help string, o opts.CommonOptions) {
	val, err := util.PickValue(message, defaultValue, req, help, o.In, o.Out, o.Err)
	utils.Check(err)
	*response = val
}
