...
Adds a git server object to your ~/.bb/gitAuth.yaml configuration. You can add different users to each git server. A git server is like github.com or github.enterprise.com, there is also bitbucket support
`)
